...
func main() {
	// 2019/12/05 23:04:45 part1 took 253.589µs
	runIntcode(readFile("./input-day5"), 1, "part1")
	// 2019/12/05 23:04:45 part2 took 107.482µs
	runIntcode(readFile("./input-day5"), 5, "part2")
}
